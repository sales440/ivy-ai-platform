              ...
              <CardContent>
                ...
                <form onSubmit={handleSendMessage} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 bg-slate-950 border border-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white placeholder:text-slate-400"
